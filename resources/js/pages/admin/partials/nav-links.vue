<template>
    <div class="pt-2 space-y-2">
        <Link href='/admin' :class="{ 'bg-gray-100': $page.url === '/admin' }"
            ...
            <svg
                aria-hidden="true"
                class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900" :class="{ 'text-gray-900': $page.url === '/admin' }"
        ...
        <Link href="/admin/products" :class="{ 'bg-gray-200': $page.url === '/admin/products' }"
              class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-200 group">
            <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900" :class="{ 'text-gray-900': $page.url === '/admin/products' }"
        ...
        <Link href="/admin/orders" :class="{ 'bg-gray-200': $page.url === '/admin/orders' }"
              class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-200 group">
            <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900" :class="{ 'text-gray-900': $page.url === '/admin/orders' }"
                 fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z">
                </path>
            </svg>
            <span class="ml-3" sidebar-toggle-item>Commandes</span>
        </Link>
