<template>
    ...
    <div class="flex items-center ml-3">
        ...
        <!-- Dropdown menu -->
        <div class="z-50 absolute top-0 right-0 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow"
            :class="state.showMenu ? 'block' : 'hidden'" id="dropdown-2">
