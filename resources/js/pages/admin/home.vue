        ...
        <div class="grid lg:grid-cols-3 lg:gap-6">
          <article class="p-4 shadow-md bg-white rounded-md">
            <div class="flex items-center">
              ...
              <div class="bg-emerald-400 p-2 rounded-md flex items-center justify-center h-[50px] w-[50px] mr-4">
                <svg class="mx-auto mb-1 text-white w-7 h-7" fill="currentColor" viewBox="0 0 20 20"
              ...
              <div>
                <h4>Total sales</h4>
                <h3 class="text-2xl font-medium">$24,000</h3>
              </div>
          ...
          <article class="p-4 shadow-md bg-white rounded-md">
            <div class="flex items-center">
              ...
              <div class="bg-indigo-400 p-2 rounded-md flex items-center justify-center h-[50px] w-[50px] mr-4">
                <svg class="mx-auto mb-1 text-white w-7 h-7" fill="currentColor" viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd"
          ...
          <article class="p-4 shadow-md bg-white rounded-md">
            <div class="flex items-center">
              ...
              <div class="bg-pink-400 p-2 rounded-md flex items-center justify-center h-[50px] w-[50px] mr-4">
                <svg class="mx-auto mb-1 text-white w-7 h-7" fill="currentColor" viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M8.433 7.418c.155-.103.346-.196.567-.267v1.698a2.305 2.305 0 01-.567-.267C8.07 8.34 8 8.114 8 8c0-.114.07-.34.433-.582zM11 12.849v-1.698c.22.071.412.164.567.267.364.243.433.468.433.582 0 .114-.07.34-.433.582a2.305 2.305 0 01-.567.267z">
              ...
              <div>
                ...
                <h3 class="text-2xl font-medium">156,00</h3>
              </div>
      ...
      <section class="grid lg:grid-cols-2 gap-4 p-4">
        ...
        <div class="bg-white rounded-md shadow-md p-4">
          <div class="rounded-md bg-blue-100 p-4">
            ...
            <p class="mt-1 text-sm">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officiis perferendis minus
              adipisci natus velit
              corporis nemo autem accusantium perspiciatis sed? Voluptates</p>

            <button type="submit" class="bg-gray-800 py-2 px-4 rounded-md text-white mt-4 hover:bg-gray-900">Add
              Product</button>
          </div>
        </div>
            ...
            <tbody>
              ...
              <tr class="bg-white hover:bg-gray-50">
                ...
                <th scope="row"
                  ...
                  <img class="w-10 h-10 rounded-full" src="https://unsplash.com/photos/ai-generated-portrait-of-a-dark-haired-model-wearing-a-pink-shirt-nT57h53Dq3c" alt="Jese image">
                  <div class="ps-3">
