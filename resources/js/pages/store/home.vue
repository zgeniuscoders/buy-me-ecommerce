...
import {Banknote, Users, ListOrdered} from "lucide-vue-next";
        ...
        <div class="space-y-4">
            ...
            <section>
                ...
                <div class="grid lg:grid-cols-3 lg:gap-6">
                    <card-stats text="Total ventes" bg-color="bg-green-400" :count="`$${totalOrdersPrice}`">
                        <Banknote/>
                    </card-stats>
            ...
            <section class="grid  gap-4">
                ...
                <Card class="p-4">
                    ...
                    <h3 class="text-xl font-bold">Ajout d'un produit</h3>
