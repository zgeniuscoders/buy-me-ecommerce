                    ...
                    <ul role="list" class="mt-4 space-y-4">
                        ...
                        <li>
                            <a href="{{ route('admin.store.create') }}"
                               class="text-base text-gray-500 hover:text-primary dark:hover:text-primary-dark">Comment devenir vendeur ?</a>
                        </li>

                        <li>
                            <a href="{{ route('admin.store.create') }}"
                               class="text-base text-gray-500 hover:text-primary dark:hover:text-primary-dark">Crée une
                                boutique</a>
                        </li>
